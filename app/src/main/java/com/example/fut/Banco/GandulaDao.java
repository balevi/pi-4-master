...
public class GandulaDao extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql3 = "create table gandtab(id integer primary key autoincrement, txtLoginGand varchar (50),txtSenhaGand varchar(50),txtNomeGand varchar(50), txtIdadeGand varchar(50),txtBairroGand varchar(50),txtTelGand varchar (12),LikeGand varchar(3),DeslikeGand varchar(3))";
